...
export interface StreamCallback {
  ...
  /**
   * Optional method to get validation failures for a specific tool call.
   * If this returns a non-empty array, the tool execution should be skipped.
   * @param toolId The tool call ID to check for validation failures
   * @returns Array of validation failure details, or undefined if not supported
   */
  ...
  /**
   * Optional method to format validation failures into an error message.
