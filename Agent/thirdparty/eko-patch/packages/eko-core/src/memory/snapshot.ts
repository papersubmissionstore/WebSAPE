    ...
    this.parameters = {
      ...
      properties: {
        reason: {
          type: "string",
          description:
            "A brief explanation of why this tool is being called, what input triggered this action, and what output is expected. This helps with debugging and understanding the agent's decision-making process.",
        },
        doneIds: {
          type: "array",
          description:
      ...
      required: ["reason", "doneIds", "taskSnapshot"],
    };
  }
